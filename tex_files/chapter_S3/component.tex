...
The second tag, \texttt{<part-s3-list-item>}, creates an visual element for each object currently in the bucket. This cycle is expressed via the attribute \texttt{``dom-repeat''}
